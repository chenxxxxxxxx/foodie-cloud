...
public class BaseController {
    ...
    public static final String USER_LOGIN_COOKIE_NAME = "myUserCenter";
...
//     * @return
//     */
//    public ttJSONResult checkUserOrder(String userId, String orderId) {
//        Orders order = myOrdersService.queryMyOrder(userId, orderId);
//        if (order == null) {
//            return ttJSONResult.errorMsg("订单不存在！");
//        }
//        return ttJSONResult.ok(order);
//    }
}
